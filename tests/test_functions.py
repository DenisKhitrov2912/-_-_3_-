...
def test_operation_date(test_func):
    assert operation_date(json_encode(test_func)) == [datetime.datetime(2019, 11, 5, 12, 4, 13, 781725),
...
def test_last_five_operations(test_func):
    assert last_five_operations(json_encode(test_func), operation_date(json_encode(test_func))) == [
...
def test_sorted_last_five(test_func):
    assert sorted_last_five(last_five_operations(json_encode(test_func), operation_date(json_encode(test_func)))) == [
